...
NextionText::NextionText(Nextion* nex, uint8_t page, uint8_t component, const char *name):
...
size_t NextionText::getText(char *buffer, size_t len)
{
...
bool NextionText::setText(char *buffer)
{
